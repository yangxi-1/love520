...
const photos = Array.from({ length: 35 }, (_, index) => ({
  id: index + 1,
  image: `/photo_wall/image${index + 1}.jpg`,
}));
...
export default function Love520Page() {
  ...
  const timeline = [
    ...
    “我还不想回去，宝宝……”`,
      images: [
        "/images/our-ring.jpg",
        "/images/first-film.jpg",
        "/images/first-nightwalk.jpg"
      ]
    },
    {
      date: "2025.09.20",
    ...
    -“啊啊啊啊啊（大声嚎叫）！
      我不想回去了，呜呜。” （哭）
    -“不行！”（坏笑，偷偷拿出手机拍照）`,
      images: ["images/first-train.jpg",
        "images/little-one.jpg"
      ]
    },
    {
      date: "2025.10.05",
    ...
    `,
      images: [
        "/images/love-library.jpg",
        "/images/write-in-museum.jpg",
        "/images/marry-me.jpg"
      ]
    },
    {
    ...
    “宝宝认真学习的样子真帅！”`,
      images: ["images/video-shot1.jpg",
        "images/video-shot2.jpg",
        "images/video-shot3.jpg",
        "images/video-shot4.jpg",
      ]
    },
    {
      date: "2025.12.21",
    ...
    `,
      images: [
        "images/first-meet-in-ks.jpg",
        "images/first-meet-in-ks-2.jpg",
        "images/zc.jpg",
    ...
    `,
      images: [
        "images/sleep-happy.jpg",
        "images/after-school-kiss.jpg",
        "images/iloveu.jpg",
      ]
    },
    {
    ...
    `,
      images: [
        "images/ride-cat.jpg",
        "images/kiss-hotel.jpg",
        "images/your-school.jpg"
      ]
    },
